...
Kết quả thực nghiệm so sánh với phương pháp điều khiển thời gian cố định (Fixed-Time) cho thấy hệ thống DQN đề xuất vượt trội ở hầu hết các chỉ số quan trọng:

\begin{itemize}
    \item \textbf{Giảm hàng đợi trung bình 83.6\%}: từ 31.54 xe/làn (Fixed-Time) xuống còn 5.18 xe/làn (DQN).
    \item \textbf{Giảm thời gian chờ 99.1\%}: từ 251.15 giây xuống còn 2.25 giây.
    \item \textbf{Tăng lưu lượng xe 9.6\%}: từ 250 xe/episode lên 274 xe/episode.
    \item \textbf{Cải thiện tổng phần thưởng 89\%}: từ $-$34,764 lên $-$3,835.
    \item \textbf{Ổn định hơn 5 lần}: độ lệch chuẩn hàng đợi giảm từ 8.45 xuống 1.65.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Tốc độ lưu thông:} Trong một số kịch bản, tốc độ trung bình của DQN thấp hơn Fixed-Time do cách đo lường bao gồm cả xe đang dừng chờ pha. Cần nghiên cứu thêm chỉ số này.
\end{itemize}
